const _dictionary = {
  a: "阿啊哀唉吖嗄锕安爱暗案按腌锕錒",
  ai:
    "爱呆挨哀埃碍艾唉矮哎癌嗌嗳嫒捱啀暧瑷皑砹硙蔼诶锿隘霭靄溾鎄溰敱敳嘊皚騃毐昹欸娾躷噯濭藹譪阨伌硋塧",
  an:
    "安暗案按垵岸俺埯庵唵菴痷揞隌桉氨豻犴胺堓婩荌洝腌晻谙铵鞍鹌黯厂广屵侒峖偣萻葊媕腤誝蓭鞌諳盦馣鮟盫鵪鶕韽玵啽雸儑貋罯錌銨闇",
  ang: "昂盎腌肮仰骯卬岇昻枊醠",
  ao: "奥澳傲熬凹嗷坳媪岙廒懊拗敖燠獒翱聱螯袄遨鏊鏖骜鳌柪梎軪爊",
  b: "不本把部便被北并别比",
  ...
  e:
    "阿恶额俄饿哦鹅厄呃噩垩娥婀屙峨愕扼猗硪胺腭苊莪萼蛤蛾讹谔轭遏邑鄂钶锷阏颚鳄鹗",
  ei: "哎诶诶",
  en: "恩摁蒽",
  er: "而二儿尔耳佴洱濡珥贰迩铒饵鲕鸸䌺",
  f: "发方分法反放风服非夫",
